...
project = "Exasol Notebook Connector"
...
# Restrict versions to include into multiversion documentation
# smv_tag_whitelist = r'^[^012].*$'
...
html_title = "Notebook Connector"
html_theme_options = {
    "light_logo": "_static/light-exasol-logo.svg",
    "dark_logo": "_static/dark-exasol-logo.svg",
    "github_url": "https://github.com/exasol/notebook-connector",
    "accent_color": "grass",
}
