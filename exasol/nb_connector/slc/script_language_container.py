...
from exasol.nb_connector.slc.package_file_editor import append_packages, ensure_pip_tools_in_package_file
...
class ScriptLanguageContainer:
    ...
    def append_custom_pip_packages(self, pip_packages: list[PipPackage]) -> None:
        ...
        """
        ensure_pip_tools_in_package_file(self.public_package_file, "flavor_customization")
        append_packages(
