from test.integration.ui.common.utils.main_config_ui_utils import render_saas_ui
...
def test_saas_main_config_ui_load(
    solara_test, page_session, ui_screenshot, tmp_path, secrets
):
...
def test_pencil_icon_on_textfield_change(
    solara_test, page_session, ui_screenshot, tmp_path, secrets, field, value
):
    render_saas_ui(page_session, secrets)
