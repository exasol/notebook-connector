...
def test_get_registered_languages(secrets):
    ...
    with patch(
        "exasol.nb_connector.language_container_activation.get_registered_languages_string",
...
def test_get_activation_sql(secrets):
    ...
    with patch(
        "exasol.nb_connector.language_container_activation.get_registered_languages",
        MagicMock(return_value={"lang1": "url1", "lang2": "url2"}),
    ):
        with patch(
            "exasol.nb_connector.language_container_activation.get_requested_languages",
